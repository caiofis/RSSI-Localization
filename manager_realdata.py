...
def showError():
	error.append(a0.predictDistance([2.5,2.5,a0.getPose()[2]]))
	plt.figure(2)
	plt.plot(i,error)
	i.append(i[-1]+1)
	plt.figure(1)
...
data = np.genfromtxt("./data/RSSI_4Antenna_20minutes.txt",delimiter="\t",dtype=int)

a0 = hardware.tag("a0")
ant1 = hardware.antenna(Id=1, pose=[0,5,1.8])#,A=-0.08043828,b=9.16771469)
ant2 = hardware.antenna(Id=2, pose=[0,0,1.8])#,A=-0.08043828,b=9.16771469)
ant3 = hardware.antenna(Id=3, pose=[5,0,1.8])#,A=-0.08043828,b=9.16771469)
ant4 = hardware.antenna(Id=4, pose=[5,5,1.8])#,A=-0.08043828,b=9.16771469)
